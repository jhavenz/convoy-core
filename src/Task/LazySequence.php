...
final class LazySequence implements StreamSource, Executable
{
    ...
    public function toArray(): Executable
    {
        ...
        return new class($terminal) implements Executable {
            public function __construct(private readonly \Convoy\Stream\Terminal\Collect $terminal) {}
            public function __invoke(ExecutionScope $scope): array { return ($this->terminal)($scope); }
        };
    }
    ...
    public function reduce(callable $fn, mixed $initial = null): Executable
    {
        ...
        return new class($terminal) implements Executable {
            public function __construct(private readonly \Convoy\Stream\Terminal\Reduce $terminal) {}
            public function __invoke(ExecutionScope $scope): mixed { return ($this->terminal)($scope); }
        };
    }
    ...
    public function first(): Executable
    {
        ...
        return new class($terminal) implements Executable {
            public function __construct(private readonly \Convoy\Stream\Terminal\First $terminal) {}
            public function __invoke(ExecutionScope $scope): mixed { return ($this->terminal)($scope); }
        };
    }
    ...
    public function consume(): Executable
    {
        ...
        return new class($terminal) implements Executable {
            public function __construct(private readonly \Convoy\Stream\Terminal\Drain $terminal) {}
            public function __invoke(ExecutionScope $scope): null { return ($this->terminal)($scope); }
        };
    }
