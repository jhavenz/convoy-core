        ...
        $bundle = new class($events) implements ServiceBundle {
            ...
            public function services(Services $services, array $context): void
            {
                ...
                $services->singleton(DatabaseConnection::class)
                    ...
                    ->onInit(static function (DatabaseConnection $db) use (&$events) {
                        $events[] = 'db:init';
                    })
                ...
                $services->scoped(RequestContext::class)
                    ...
                    ->onDispose(static function (RequestContext $ctx) use (&$events) {
                ...
                $services->eager(MetricsCollector::class)
                    ...
                    ->onStartup(static function (MetricsCollector $m) use (&$events) {
                        $events[] = 'metrics:startup';
                    })
                    ->onShutdown(static function (MetricsCollector $m) use (&$events) {
